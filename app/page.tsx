...
// Températures drop cibles : Cinnamon=410, Light=425, City=435,
// Full City+=445, Dark=455, French=465°F
// 1er crack typique ~375-385°F, 2e crack ~430-440°F
const PROFILS = [
  {
    id: "sr800_cinnamon", label: "SR800 – Cinnamon", emoji: "🌿",
    desc: "Très légère, acidité vive, drop ~410°F, ~7.5 min",
    couleur_cible: "cinnamon",
    points: [
      { t: 0,   ref: 290 }, { t: 0.5, ref: 265 }, { t: 1.0, ref: 250 },
      { t: 1.5, ref: 252 }, { t: 2.0, ref: 262 }, { t: 2.5, ref: 278 },
      { t: 3.0, ref: 295 }, { t: 3.5, ref: 311 }, { t: 4.0, ref: 326 },
      { t: 4.5, ref: 340 }, { t: 5.0, ref: 352 }, { t: 5.5, ref: 363 },
      { t: 6.0, ref: 372 }, { t: 6.5, ref: 380 }, { t: 7.0, ref: 388 },
      { t: 7.5, ref: 410 },
    ],
  },
  {
    id: "sr800_light", label: "SR800 – Light", emoji: "🌤",
    desc: "Légère, floraux et agrumes, drop ~425°F, ~9 min",
    couleur_cible: "light",
    points: [
      { t: 0,   ref: 290 }, { t: 0.5, ref: 264 }, { t: 1.0, ref: 249 },
      { t: 1.5, ref: 251 }, { t: 2.0, ref: 261 }, { t: 2.5, ref: 276 },
      { t: 3.0, ref: 292 }, { t: 3.5, ref: 308 }, { t: 4.0, ref: 322 },
      { t: 4.5, ref: 335 }, { t: 5.0, ref: 347 }, { t: 5.5, ref: 358 },
      { t: 6.0, ref: 368 }, { t: 6.5, ref: 377 }, { t: 7.0, ref: 385 },
      { t: 7.5, ref: 393 }, { t: 8.0, ref: 405 }, { t: 8.5, ref: 415 },
      { t: 9.0, ref: 425 },
    ],
  },
  {
    id: "sr800_city", label: "SR800 – City", emoji: "☀️",
    desc: "Équilibrée, caramel léger, drop ~435°F, ~10.5 min",
    couleur_cible: "city",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 263 }, { t: 1.0,  ref: 248 },
      { t: 1.5,  ref: 250 }, { t: 2.0,  ref: 260 }, { t: 2.5,  ref: 275 },
      { t: 3.0,  ref: 291 }, { t: 3.5,  ref: 306 }, { t: 4.0,  ref: 320 },
      { t: 4.5,  ref: 333 }, { t: 5.0,  ref: 345 }, { t: 5.5,  ref: 356 },
      { t: 6.0,  ref: 366 }, { t: 6.5,  ref: 375 }, { t: 7.0,  ref: 383 },
      { t: 7.5,  ref: 391 }, { t: 8.0,  ref: 399 }, { t: 8.5,  ref: 408 },
      { t: 9.0,  ref: 416 }, { t: 9.5,  ref: 422 }, { t: 10.0, ref: 428 },
      { t: 10.5, ref: 435 },
    ],
  },
  {
    id: "sr800_full_city_plus", label: "SR800 – Full City+", emoji: "🌆",
    desc: "Chocolaté, corps plein, drop ~445°F, ~12 min",
    couleur_cible: "full_city",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 262 }, { t: 1.0,  ref: 247 },
      { t: 1.5,  ref: 249 }, { t: 2.0,  ref: 259 }, { t: 2.5,  ref: 274 },
      { t: 3.0,  ref: 289 }, { t: 3.5,  ref: 304 }, { t: 4.0,  ref: 318 },
      { t: 4.5,  ref: 331 }, { t: 5.0,  ref: 343 }, { t: 5.5,  ref: 354 },
      { t: 6.0,  ref: 364 }, { t: 6.5,  ref: 373 }, { t: 7.0,  ref: 381 },
      { t: 7.5,  ref: 389 }, { t: 8.0,  ref: 397 }, { t: 8.5,  ref: 405 },
      { t: 9.0,  ref: 413 }, { t: 9.5,  ref: 420 }, { t: 10.0, ref: 427 },
      { t: 10.5, ref: 433 }, { t: 11.0, ref: 438 }, { t: 11.5, ref: 442 },
      { t: 12.0, ref: 445 },
    ],
  },
  {
    id: "sr800_dark", label: "SR800 – Dark", emoji: "🌑",
    desc: "Intense, fumé, début 2e crack, drop ~455°F, ~13 min",
    couleur_cible: "dark",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 261 }, { t: 1.0,  ref: 246 },
      { t: 1.5,  ref: 248 }, { t: 2.0,  ref: 258 }, { t: 2.5,  ref: 273 },
      { t: 3.0,  ref: 288 }, { t: 3.5,  ref: 303 }, { t: 4.0,  ref: 317 },
      { t: 4.5,  ref: 330 }, { t: 5.0,  ref: 342 }, { t: 5.5,  ref: 353 },
      { t: 6.0,  ref: 363 }, { t: 6.5,  ref: 372 }, { t: 7.0,  ref: 380 },
      { t: 7.5,  ref: 388 }, { t: 8.0,  ref: 396 }, { t: 8.5,  ref: 404 },
      { t: 9.0,  ref: 412 }, { t: 9.5,  ref: 419 }, { t: 10.0, ref: 426 },
      { t: 10.5, ref: 432 }, { t: 11.0, ref: 437 }, { t: 11.5, ref: 442 },
      { t: 12.0, ref: 447 }, { t: 12.5, ref: 451 }, { t: 13.0, ref: 455 },
    ],
  },
  {
    id: "sr800_french", label: "SR800 – French Roast", emoji: "🔥",
    desc: "Très foncé, huileux, 2e crack développé, drop ~465°F, ~14 min",
    couleur_cible: "dark",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 260 }, { t: 1.0,  ref: 245 },
      { t: 1.5,  ref: 247 }, { t: 2.0,  ref: 257 }, { t: 2.5,  ref: 272 },
      { t: 3.0,  ref: 287 }, { t: 3.5,  ref: 302 }, { t: 4.0,  ref: 316 },
      { t: 4.5,  ref: 329 }, { t: 5.0,  ref: 341 }, { t: 5.5,  ref: 352 },
      { t: 6.0,  ref: 362 }, { t: 6.5,  ref: 371 }, { t: 7.0,  ref: 379 },
      { t: 7.5,  ref: 387 }, { t: 8.0,  ref: 395 }, { t: 8.5,  ref: 403 },
      { t: 9.0,  ref: 411 }, { t: 9.5,  ref: 418 }, { t: 10.0, ref: 425 },
      { t: 10.5, ref: 431 }, { t: 11.0, ref: 436 }, { t: 11.5, ref: 441 },
      { t: 12.0, ref: 446 }, { t: 12.5, ref: 451 }, { t: 13.0, ref: 456 },
      { t: 13.5, ref: 461 }, { t: 14.0, ref: 465 },
    ],
  },
];
