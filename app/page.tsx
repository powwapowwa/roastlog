...
// Calibré sur expérience réelle : 1er crack ~375-380°F vers 9.75-10 min
// Drop cibles : Cinnamon=410, Light=425, City=435, Full City+=445, Dark=455, French=465°F
const PROFILS = [
  {
    id: "sr800_cinnamon", label: "SR800 – Cinnamon", emoji: "🌿",
    desc: "Drop juste après 1er crack ~410°F, ~11 min",
    couleur_cible: "cinnamon",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 265 }, { t: 1.0,  ref: 250 },
      { t: 1.5,  ref: 252 }, { t: 2.0,  ref: 260 }, { t: 2.5,  ref: 271 },
      { t: 3.0,  ref: 284 }, { t: 3.5,  ref: 297 }, { t: 4.0,  ref: 309 },
      { t: 4.5,  ref: 320 }, { t: 5.0,  ref: 330 }, { t: 5.5,  ref: 340 },
      { t: 6.0,  ref: 348 }, { t: 6.5,  ref: 356 }, { t: 7.0,  ref: 362 },
      { t: 7.5,  ref: 367 }, { t: 8.0,  ref: 371 }, { t: 8.5,  ref: 374 },
      { t: 9.0,  ref: 377 }, { t: 9.5,  ref: 379 }, { t: 10.0, ref: 381 },
      { t: 10.5, ref: 396 }, { t: 11.0, ref: 410 },
    ],
  },
  {
    id: "sr800_light", label: "SR800 – Light", emoji: "🌤",
    desc: "Court développement après 1er crack, drop ~425°F, ~12 min",
    couleur_cible: "light",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 264 }, { t: 1.0,  ref: 249 },
      { t: 1.5,  ref: 251 }, { t: 2.0,  ref: 259 }, { t: 2.5,  ref: 270 },
      { t: 3.0,  ref: 282 }, { t: 3.5,  ref: 295 }, { t: 4.0,  ref: 307 },
      { t: 4.5,  ref: 318 }, { t: 5.0,  ref: 328 }, { t: 5.5,  ref: 337 },
      { t: 6.0,  ref: 345 }, { t: 6.5,  ref: 353 }, { t: 7.0,  ref: 360 },
      { t: 7.5,  ref: 365 }, { t: 8.0,  ref: 370 }, { t: 8.5,  ref: 373 },
      { t: 9.0,  ref: 376 }, { t: 9.5,  ref: 378 }, { t: 10.0, ref: 380 },
      { t: 10.5, ref: 392 }, { t: 11.0, ref: 404 }, { t: 11.5, ref: 415 },
      { t: 12.0, ref: 425 },
    ],
  },
  {
    id: "sr800_city", label: "SR800 – City", emoji: "☀️",
    desc: "Développement modéré après 1er crack, drop ~435°F, ~13 min",
    couleur_cible: "city",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 263 }, { t: 1.0,  ref: 248 },
      { t: 1.5,  ref: 250 }, { t: 2.0,  ref: 258 }, { t: 2.5,  ref: 269 },
      { t: 3.0,  ref: 281 }, { t: 3.5,  ref: 293 }, { t: 4.0,  ref: 305 },
      { t: 4.5,  ref: 316 }, { t: 5.0,  ref: 326 }, { t: 5.5,  ref: 335 },
      { t: 6.0,  ref: 344 }, { t: 6.5,  ref: 351 }, { t: 7.0,  ref: 358 },
      { t: 7.5,  ref: 364 }, { t: 8.0,  ref: 369 }, { t: 8.5,  ref: 373 },
      { t: 9.0,  ref: 376 }, { t: 9.5,  ref: 378 }, { t: 10.0, ref: 380 },
      { t: 10.5, ref: 390 }, { t: 11.0, ref: 401 }, { t: 11.5, ref: 411 },
      { t: 12.0, ref: 420 }, { t: 12.5, ref: 428 }, { t: 13.0, ref: 435 },
    ],
  },
  {
    id: "sr800_full_city_plus", label: "SR800 – Full City+", emoji: "🌆",
    desc: "Développement soutenu, début 2e crack, drop ~445°F, ~14 min",
    couleur_cible: "full_city",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 262 }, { t: 1.0,  ref: 247 },
      { t: 1.5,  ref: 249 }, { t: 2.0,  ref: 257 }, { t: 2.5,  ref: 268 },
      { t: 3.0,  ref: 280 }, { t: 3.5,  ref: 292 }, { t: 4.0,  ref: 304 },
      { t: 4.5,  ref: 315 }, { t: 5.0,  ref: 325 }, { t: 5.5,  ref: 334 },
      { t: 6.0,  ref: 342 }, { t: 6.5,  ref: 350 }, { t: 7.0,  ref: 357 },
      { t: 7.5,  ref: 363 }, { t: 8.0,  ref: 368 }, { t: 8.5,  ref: 372 },
      { t: 9.0,  ref: 375 }, { t: 9.5,  ref: 378 }, { t: 10.0, ref: 380 },
      { t: 10.5, ref: 389 }, { t: 11.0, ref: 399 }, { t: 11.5, ref: 408 },
      { t: 12.0, ref: 417 }, { t: 12.5, ref: 425 }, { t: 13.0, ref: 432 },
      { t: 13.5, ref: 439 }, { t: 14.0, ref: 445 },
    ],
  },
  {
    id: "sr800_dark", label: "SR800 – Dark", emoji: "🌑",
    desc: "2e crack développé, huile en surface, drop ~455°F, ~15 min",
    couleur_cible: "dark",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 261 }, { t: 1.0,  ref: 246 },
      { t: 1.5,  ref: 248 }, { t: 2.0,  ref: 256 }, { t: 2.5,  ref: 267 },
      { t: 3.0,  ref: 279 }, { t: 3.5,  ref: 291 }, { t: 4.0,  ref: 303 },
      { t: 4.5,  ref: 314 }, { t: 5.0,  ref: 324 }, { t: 5.5,  ref: 333 },
      { t: 6.0,  ref: 341 }, { t: 6.5,  ref: 349 }, { t: 7.0,  ref: 356 },
      { t: 7.5,  ref: 362 }, { t: 8.0,  ref: 367 }, { t: 8.5,  ref: 371 },
      { t: 9.0,  ref: 374 }, { t: 9.5,  ref: 377 }, { t: 10.0, ref: 379 },
      { t: 10.5, ref: 388 }, { t: 11.0, ref: 397 }, { t: 11.5, ref: 406 },
      { t: 12.0, ref: 415 }, { t: 12.5, ref: 423 }, { t: 13.0, ref: 430 },
      { t: 13.5, ref: 437 }, { t: 14.0, ref: 443 }, { t: 14.5, ref: 449 },
      { t: 15.0, ref: 455 },
    ],
  },
  {
    id: "sr800_french", label: "SR800 – French Roast", emoji: "🔥",
    desc: "Très foncé, 2e crack roulant, drop ~465°F, ~16 min",
    couleur_cible: "dark",
    points: [
      { t: 0,    ref: 290 }, { t: 0.5,  ref: 260 }, { t: 1.0,  ref: 245 },
      { t: 1.5,  ref: 247 }, { t: 2.0,  ref: 255 }, { t: 2.5,  ref: 266 },
      { t: 3.0,  ref: 278 }, { t: 3.5,  ref: 290 }, { t: 4.0,  ref: 302 },
      { t: 4.5,  ref: 313 }, { t: 5.0,  ref: 323 }, { t: 5.5,  ref: 332 },
      { t: 6.0,  ref: 340 }, { t: 6.5,  ref: 348 }, { t: 7.0,  ref: 355 },
      { t: 7.5,  ref: 361 }, { t: 8.0,  ref: 366 }, { t: 8.5,  ref: 370 },
      { t: 9.0,  ref: 373 }, { t: 9.5,  ref: 376 }, { t: 10.0, ref: 378 },
      { t: 10.5, ref: 387 }, { t: 11.0, ref: 396 }, { t: 11.5, ref: 405 },
      { t: 12.0, ref: 413 }, { t: 12.5, ref: 421 }, { t: 13.0, ref: 428 },
      { t: 13.5, ref: 435 }, { t: 14.0, ref: 441 }, { t: 14.5, ref: 447 },
      { t: 15.0, ref: 453 }, { t: 15.5, ref: 459 }, { t: 16.0, ref: 465 },
    ],
  },
];
...
const EVENT_DEFS = [
  ...
  { id: "crack2",   label: "2e crack",    short: "2CR", color: "#C084FC" },
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <ComposedChart margin={{ top: 4, right: 18, left: 0, bottom: 18 }}>
        ...
        <YAxis domain={[220, 480]} tickFormatter={v => `${v}°`} tick={{ fill: C.muted, fontSize: 10 }} stroke={C.border} />
